...
echo "=== Building Imania extraction containers ==="
...
echo ""
echo "=== Build complete ==="
docker images --filter "reference=imania-extract-*" --format "table {{.Repository}}\t{{.Size}}\t{{.CreatedSince}}"
