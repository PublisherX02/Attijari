...
def test_gmail_bridge_skips_when_active_mailbox_is_pop3(monkeypatch):
    ...
    monkeypatch.setattr(
        bridge, "get_active_mailbox_credentials",
    ...
    class FakeSessionLocal:
        ...
        def close(self):
            pass
    monkeypatch.setattr(bridge, "SessionLocal", FakeSessionLocal())
...
def test_skips_when_no_active_mailbox(monkeypatch):
    ...
    class FakeSessionLocal:
        ...
        def close(self):
            pass
    monkeypatch.setattr(bridge, "SessionLocal", FakeSessionLocal())
    monkeypatch.setattr(bridge, "get_active_mailbox_credentials", lambda db: None, raising=False)
